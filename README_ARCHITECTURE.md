...
- E2E (Playwright):
  - إنشاء تفويض كمانح.
  - قبول/رفض كمفوَّض مع عرض الشروط بخط واحد RTL/LTR وتسجيل الموافقة.
  - محاذاة RTL/LTR للنصوص وإعادة ضبط الحالة عند إعادة فتح النافذة.
  - أرشفة/حذف.
  - تطبيع الأرقام للهوية/الجوال للإنجليزية.
  - تدفق طلب مندوب موثّق في تبويب إمكانية الوصول (موقع المستخدم + تكلفة 200 ﷼، دعم اللغتين).
